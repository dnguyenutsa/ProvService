...
import provenance.policy.glance.proxy
...
class Enforcer(object):
    ...
    def _check(self, context, rule, target, *args, **kwargs):
        """Verifies that the action is valid on the target in this context.
           ...
           :raises: `provenance.common.exception.Forbidden`
...
class ImageRepoProxy(provenance.policy.glance.proxy.Repo):
...
class ImageProxy(provenance.policy.glance.proxy.Image):
...
class ImageFactoryProxy(provenance.policy.glance.proxy.ImageFactory):
...
class ImageMemberFactoryProxy(provenance.policy.glance.proxy.ImageMembershipFactory):
...
class ImageMemberRepoProxy(provenance.policy.glance.proxy.Repo):
