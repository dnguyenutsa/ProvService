...
class ContextMiddleware(BaseContextMiddleware):
    ...
    def process_request(self, req):
        ...
        Generate a provenance.context.RequestContext object from the available
    ...
    def _get_anonymous_context(self):
        ...
        return provenance.context.RequestContext(**kwargs)
...
class UnauthenticatedContextMiddleware(BaseContextMiddleware):
    def process_request(self, req):
        ...
        req.context = provenance.context.RequestContext(**kwargs)
