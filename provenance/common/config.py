...
from provenance.version import version_info as version
...
paste_deploy_opts = [
    cfg.StrOpt('flavor',
               help=_('Partial name of a pipeline in your paste configuration '
                      ...
                      '[pipeline:provenance-api-keystone] use the value '
                      '"keystone"')),
...
common_opts = [
    ...
    cfg.StrOpt('data_api', default='provenance.db.sqlalchemy.api',
...
CONF.import_opt('verbose', 'provenance.openstack.common.log')
CONF.import_opt('debug', 'provenance.openstack.common.log')
CONF.import_opt('log_dir', 'provenance.openstack.common.log')
CONF.import_opt('log_file', 'provenance.openstack.common.log')
CONF.import_opt('log_config', 'provenance.openstack.common.log')
CONF.import_opt('log_format', 'provenance.openstack.common.log')
CONF.import_opt('log_date_format', 'provenance.openstack.common.log')
CONF.import_opt('use_syslog', 'provenance.openstack.common.log')
CONF.import_opt('syslog_log_facility', 'provenance.openstack.common.log')
...
def parse_cache_args(args=None):
    config_files = cfg.find_config_files(project='provenance', prog='provenance-cache')
