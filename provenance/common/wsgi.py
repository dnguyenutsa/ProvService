...
import provenance.openstack.common.log as os_logging
...
class Server(object):
    ...
    def start(self, application, default_port):
        ...
        try:
            ...
            # NOTE(flaper87): When running provenance-control,
            # (provenance's functional tests, for example)
            # setpgid fails with EPERM as provenance-control
            ...
            #
            # Running provenance-(api|registry) is safe and
